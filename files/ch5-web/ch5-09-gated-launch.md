...
![online group](https://icake-1251124623.cos.ap-guangzhou.myqcloud.com/images/ch5-online-group.png)
...
![set 和 get 流程不应该因为灰度走到不同版本的 API](https://icake-1251124623.cos.ap-guangzhou.myqcloud.com/images/ch5-set-time-line.png)

*图 5-21 先set然后马上get*

如果采用随机策略，可能会出现像*图 5-22*这样的问题：

![set 和 get 流程不应该因为灰度走到不同版本的 API](https://icake-1251124623.cos.ap-guangzhou.myqcloud.com/images/ch5-set-time-line_2.png)
